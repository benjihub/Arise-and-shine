...
const Color primaryColor = Color.fromARGB(255, 3, 32, 252);
const Color goldenColor = Color.fromARGB(255, 255, 187, 0);
...
const Color darkCharcoalColor = Color(0xFF36393F);

const Color whiteColor = Colors.white;

const Color greyColor = Color.fromARGB(255, 128, 128, 128);
const Color lightGreyColor = Color.fromARGB(255, 235, 235, 235);
const Color darkGreyColor = Color.fromARGB(255, 30, 30, 36);
