    ...
    return Obx(
      () => SizedBox(
        ...
        child: sermonsController.isLoading.isTrue
            ...
            : sermonsController.videoSermons.isEmpty
                ? const ProductsSkelton()
                : ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: 10,
                    itemBuilder: (context, index) {
                      final video = sermonsController.videoSermons[index];
                      ...
                      return Padding(
                        padding: EdgeInsets.only(
                          left: defaultPadding,
                          right:
                              index == sermonsController.videoSermons.length - 1
                                  ? 20
                                  : 0,
                        ),
                        child: Container(
                          ...
                          () {
                            Get.to(
                              () => VideoSermonDetails(
                                videoData: video,
                                videos: sermonsController.videoSermons,
                              ),
